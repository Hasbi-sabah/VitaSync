  ...
  return (
    <div className="mt-32 sm:mt-14 lg:mt-10 flex flex-col lg:flex justify-center lg:flex-row flex-wrap items-center gap-5 sm:gap-8 lg:gap-20">
      ...
      <button
        ...
        className="uppercase bg-blue text-white h-16 w-72 rounded-[20px] relative font-semibold text-base hover:bg-lightBlue"
      >
      ...
      <button onClick={() => setActiveQrScanner(true)} className="h-16 w-72 bg-actualLightBlue rounded-[20px] relative text-base font-semibold text-white hover:bg-actualLightBlue2 hover:cursor-pointer">
