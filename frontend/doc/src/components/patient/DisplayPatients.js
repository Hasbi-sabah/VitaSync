...
const DisplayPatients = ( {data, label}) => {
    ...
    return (
    <div className='sm:w-[69rem] sm:rounded-[1.875rem] bg-white mt-9 mx-5 sm:mx-auto sm:px-10 pb-8'>
        <h3 className='text-left text-2xl sm:text-xl font-semibold py-3 pl-2 sm:py-6'>{label}</h3>
        <table className='min-w-full text-base'>
            <thead className='h-12'>
                <tr className='bg-darkBlue text-white'>
                    <th className="px-3 sm:px-4 text-lg sm:text-base">SN</th>
                    <th className="px-4 ">Name</th>
                    <th className="px-3 sm:px-4">Sex</th>
                    <th className="px-3 sm:px-4">Age</th>
