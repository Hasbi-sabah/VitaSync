...
const MenuItem = ({ label }) => {
    ...
    const icons = {'dashboard': dashboardIcon, 'patients': patientManIcon, 'records': recordIcon, 'logout': logoutIcon}
    const labels = {'dashboard': 'Dashboard', 'patients': 'Patient Management', 'records': 'Records', 'logout': 'Logout'}
