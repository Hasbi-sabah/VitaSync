...
const CreateSearchPatient = ({ setActiveQrScanner }) => {
  ...
  return (
      <div className="mt-32 sm:mt-24 lg:mt-32 flex flex-col justify-center lg:flex-row items-center gap-5 sm:gap-8 lg:gap-20">
        ...
        <button onClick={() => setActiveQrScanner(true)} className="h-16 w-72 bg-lightBlue rounded-[20px] relative text-base font-semibold text-white hover:bg-actualLightBlue2 hover:cursor-pointer">
