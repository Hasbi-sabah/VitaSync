...
drugs = [
    ...
    Drug(commercialName='Lipitor', activeIngredient='Atorvastatin Calcium', distributor='PharmaCare', description='Statins for lowering cholesterol levels', dose='40 mg', form='Tablet', status=True, price=round(random.uniform(20, 100), 2)),
